...
import { Clock, Plus, Home as HomeIcon, FolderOpen, CheckSquare, BarChart3, Settings, LogOut, Search, Bell, User, MoreVertical, CheckCircle2, Circle, AlertCircle } from 'lucide-react';
import { FaSkull, FaTasks } from "react-icons/fa";
              ...
              <>
                ...
                <div className="grid grid-cols-4 gap-4 mb-8">
                  <div className="bg-white rounded-lg border border-border shadow-sm p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="w-12 h-12 bg-secondary rounded-lg flex items-center justify-center">
                        <BsCpuFill className="w-6 h-6 text-primary" />
                      </div>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg border border-border shadow-sm p-6">
                  ...
                  <div className="bg-white rounded-lg border border-border shadow-sm p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="w-12 h-12 bg-secondary rounded-lg flex items-center justify-center">
                        <FaSkull className="w-6 h-6 text-primary" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <section className="mb-12">
                  ...
                  <div>
                    ...
                    <div className="mb-6 rounded-lg border border-border bg-gradient-to-r from-[#e8f2ef] via-[#f8f7f5] to-[#e3efeb] overflow-hidden shadow-sm">
                      <iframe
                        src="/deadline-animation/index.html"
                        title="Deadline Animation"
